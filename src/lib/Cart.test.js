...
describe('Cart', () => {
  ...
  describe('getTotal()', () => {
    it('should return 0 when getTotal() is execute in a newly created instance', () => {
    ...
    it('should update total when a product gets includeded and then remove', () => {
      cart.add({
        product,
        quantity: 2,
      });
  ...
  describe('checkout()', () => {
    ...
    it('should return an object with the total and the list of items when sumarry() is called', () => {
      cart.add({
        product,
        quantity: 1,
      });
    ...
    it('should include formatted amount in the summary', () => {
      ...
      expect(cart.sumarry().formatted).toEqual('R$1,610.04');
    });
  ...
  describe('special conditions', () => {
    ...
    it('should NOT apply quantity discount for even quantities when is not met', () => {
      const condition = {
        quantity: 2,
      };
